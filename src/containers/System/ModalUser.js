...
class ModalUser extends Component {
    ...
    handleOnChangeInput = (event,id) => {
        // good code
        let copyState = {...this.state};//{} tượng trưng 1 object
        ...
        this.state.email === this.state['email'] bản chất object là mảng
        */
    }
    checkValideInput = () => {
        let isValid = true;
    ...
    handleAddNewUser = () => {
        ...
        if(isValid === true) {
            ...
            // truyền data của new user sang cho cha -UserManage
